...
public class ImageLoader {
     ...
     */
    private class BatchedImageRequest implements ProgressListener {
        ...
        public void progressUpdate(int progress) {
        	...
        	//Log.d("BatchedImageRequest", "progress update" + progress);
        	batchProgress(BatchedImageRequest.this, progress);
    ...
    private void batchProgress(final BatchedImageRequest req, final int progress) {
    	
    	mProgressRunnable = new Runnable() {
			
			@Override
			public void run() {
				for (ImageContainer container : req.mContainers) {
					container.mListener.onProgressUpdate(progress);
				}
			}
		};
